...
public class enemyHealth2 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        Collider2D enemyCollidedWith = Physics2D.OverlapBox(new Vector2(enemyLocation2.position.x - 0.1153f, enemyLocation2.position.y - 0.453f), new Vector2(2.025f, 1f), 0f, layers2);
